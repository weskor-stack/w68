...
class ConfiguradorUI:
    ...
    def _build_ui(self):
        ...
        # ID OPERATOR
        tk.Label(inner, text="OPERATOR ID", bg=BG_MAIN, fg=FG_BLUE_LABEL, font=FONT_LABEL).grid(row=0, column=1, sticky="w", padx=(15,0))
        ...
        # PCB PROCESS
        tk.Label(inner, text="PCB PROCESS", bg=BG_MAIN, fg=FG_BLUE_LABEL, font=FONT_LABEL).grid(row=4, column=0, sticky="w")
